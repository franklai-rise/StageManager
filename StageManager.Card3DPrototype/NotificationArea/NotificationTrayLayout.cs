...
internal static class NotificationTrayLayout
{
	...
	public static IReadOnlyList<Rectangle> Arrange(Size cardSize, IReadOnlyList<Size> iconSizes)
	{
		...
		var availableHeight = Math.Max(1, cardSize.Height - inset * 2);
		...
		for (var index = 0; index < count; index++)
		{
			...
			var top = (int)Math.Round(inset + row * cellHeight + (cellHeight - iconSize.Height) / 2f);
